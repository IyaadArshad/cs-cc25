  ...
  return (
    ...
    >
      <div
        ...
        className="transition-all duration-500 ease-in-out bg-gradient-to-b from-[#12121d]/80 to-[#12121d]/95 backdrop-blur-xl main-card fixed sm:relative sm:rounded-[18px] overflow-hidden flex flex-col"
      >
        {/* Main Content Area */}
